        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateRealise = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AudioTracksId = table.Column<int>(type: "integer", nullable: false),
                    MoviesId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AudioTrackMovie", x => new { x.AudioTracksId, x.MoviesId });
                    table.ForeignKey(
                        name: "FK_AudioTrackMovie_AudioTracks_AudioTracksId",
                        column: x => x.AudioTracksId,
                        principalTable: "AudioTracks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AudioTrackMovie_Movies_MoviesId",
                        column: x => x.MoviesId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AudioTrackMovie_MoviesId",
                table: "AudioTrackMovie",
                column: "MoviesId");
